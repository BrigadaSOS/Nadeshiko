...
<div class="anki">
            ...
            >
              ...
              <p class="mt-2 text-sm text-red-700 dark:text-red-200">No se ha podido establecer conexión con Anki.</p>
            ...
            <div class="border rounded-lg overflow-hidden dark:border-sgray2 mb-10">
              <table class="min-w-full divide-y bg-sgray2 divide-gray-200 dark:divide-white/30">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-white/20">
                  <tr class="divide-x divide-gray-200 dark:divide-white/20" v-for="(item, index) in fieldOptions">
                    ...
                    <td
                      class="whitespace-nowrap text-center text-base px-2 font-medium text-gray-800 dark:text-gray-200"
                    >
                      <div class="bg-sgray2 border my-3 mx-2 rounded-lg dark:bg-slate-900 dark:border-white/20">
                            ...
                            <div>
                              <div class="hs-dropdown relative inline-flex">
                                <button
                                  ...
                                  type="button"
                                  class="w-7 h-10 rounded-e-md inline-flex justify-center items-center text-sm font-medium bg-gray-50 text-gray-800 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:bg-sgray2 dark:text-white dark:hover:bg-sgray dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                >
                                  <svg
                                ...
                                >
                                  <div class="py-2 first:pt-0 last:pb-0">
                                    ...
                                    <a
                                      @click="setKeyValueField(item.key, '{image}')"
                                    ...
                                    <a
                                      @click="setKeyValueField(item.key, '{sentence-audio}')"
                                      class="flex cursor-pointer items-center gap-x-3.5 py-2 px-3 rounded-md text-sm xxl:text-base xxm:text-2xl text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-sgrayhover dark:hover:text-gray-300"
                                    >
                                      <svg
                                        class="flex-none"
                                  ...
                                  <div class="py-2 first:pt-0 last:pb-0">
                                    ...
                                    <a
                                      @click="setKeyValueField(item.key, '{sentence-jp}')"
                                      class="flex cursor-pointer items-center gap-x-3.5 py-2 px-3 rounded-md text-sm xxl:text-base xxm:text-2xl text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-sgrayhover dark:hover:text-gray-300"
                                    >
                                      <svg
                                        class="flex-none"
