...
const editusername = async () => {
  ...
  try {
    response = await fetch(import.meta.env.VITE_APP_BASE_URL_BACKEND + `jwt/files/editusername`, {
      method: 'POST',
      mode: 'cors',
...
<template>
  <div
    id="hs-vertically-centered-scrollable-editusername"
  ...
  >
    ...
    >
      <div
        class="max-h-full l flex flex-col bg-white border shadow-sm rounded-xl w-96 dark:bg-bgcolorcontext dark:border-sgray dark:shadow-slate-700/[.7]"
      >
        <div class="flex justify-between items-center py-3 px-4 border-b dark:border-sgray2">
          <h3 class="font-bold text-gray-800 dark:text-white">Editar nombre de usuario</h3>
          <button
            type="button"
        ...
        <div class="overflow-y-auto">
          <div class="flex flex-row mx-auto">
            <div class="container w-full sm:mx-4 mx-auto flex flex-col">
              <div class="px-2 py-4 space-y-6">
                <p class="flex flex-col text-base leading-relaxed text-gray-500 dark:text-gray-400">
                  ...
                  <input
                    ...
                    v-model="folderName"
                    placeholder=""
                    class=" w-full text-white mt-2 rounded-md bg-gray-100 border-gray-300 focus:ring-sred dark:focus:ring-sred dark:ring-offset-gray-800 focus:ring-2 dark:bg-sgray dark:border-sgray"
                  />
                </p>
                <p class="flex flex-col text-base leading-relaxed text-gray-500 dark:text-gray-400">
                  Contraseña Actual
