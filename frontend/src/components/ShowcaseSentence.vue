...
<template>
  ...
  <div class="sticky z-30 top-0" id="search-bar" ref="searchBar">
    <form @submit="searchHandler">
      <label for="default-search" class="mb-2 text-sm xxl:text-base xxm:text-2xl font-medium z-30 text-gray-900 sr-only dark:text-white">{{
        ...
        >
          ...
          <div class="w-full py-6 sm:py-2 px-6 text-white flex flex-col justify-between">
            <div className="inline-flex items-start justify-center">
              ...
              <h3 class="font-semibold ml-2 items-start  text-xl xxl:text-2xl xxl:font-normal xxm:text-3xl leading-tight">
            ...
            <h4 class="font-normal text-sm xxl:text-base xxm:text-2xl leading-tight my-4">
              ...
              <ul class="ml-5 xxm:ml-8 list-disc text-gray-400">
                <li class="my-2 text-sm xxl:text-base xxm:text-2xl" v-for="segment in orderedSegments" :key="segment.content">
