export default {
  ...
  home: {
    ...
    support: {
      ...
      description:
        'このサイトが役に立った場合は、GitHubでの支援、寄付、またはこのサイトを共有することで、今後の開発をサポートできます。',
    },
    stats: {
      sentenceCount: '文',
      episodeCount: 'エピソード',
  ...
  batchSearch: {
    title: '同時検索',
    description1:
      'この機能を使うと、複数の単語を一度に検索できます。データベース内で見つかった単語のリストと、その検索へのリンクが表示されます。',
  ...
  anki: {
    modal: {
      title: 'コレクション内を検索',
      description:
        'Ankiにあるカードを検索し、画像や音声を追加できます。「キーフィールド」が設定タブで設定されている必要があります。',
      idColumn: 'ID',
      keyColumn: 'キー',
    ...
    toast: {
      ...
      cardFoundInOtherDeck:
        'カードが見つかりましたが、デッキ「{deck}」にありません。YomitanとNadeshikoが同じデッキを使用しているか確認してください。',
  ...
  modalSegmentEdit: {
    ...
    deleteEpisodeConfirm: 'エピソード {episode} とそのすべてのセグメントを削除しますか？',
    deleteEpisodeYes: '削除',
    deleteEpisodeSuccess: 'エピソードを削除しました',
    deleteEpisodeError: 'エピソードの削除に失敗しました',
  },
  filterContent: {
  ...
  accountSettings: {
    ...
    anki: {
      ...
      newProfile: '新規',
      renameProfile: '名前変更',
      profileNamePlaceholder: 'プロフィール名',
      deleteProfile: '削除',
      openBrowserOnExport: 'カードをエクスポート時にAnkiブラウザを開く',
      saving: '保存中...',
    },
  },
  errorPage: {
