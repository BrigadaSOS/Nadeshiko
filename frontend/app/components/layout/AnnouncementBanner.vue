...
<template>
  ...
  <div v-if="!dismissed" class="fixed inset-0 z-50">
    ...
    <button @click="dismissed = true" class="absolute -top-2.5 -right-2.5 p-1 rounded-full bg-[var(--modal-input)] border border-[var(--modal-border)] hover:bg-[#d94845] transition-colors" aria-label="Dismiss banner">
