...
<div 
  ...
  >    <Transition>
    ...
    <button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="nd-offcanvas-right" data-nd-overlay="#nd-offcanvas-right"
  ...
  <!-- Sidebar -->
  <div id="nd-offcanvas-right" class="nd-overlay nd-overlay-backdrop-open:bg-neutral-900/40 nd-overlay-open:translate-x-0 hidden translate-x-full fixed top-0 end-0 transition-all duration-300 transform h-full max-w-xs w-full z-[80] bg-white border-s dark:bg-neutral-800 dark:border-neutral-700" role="dialog" tabindex="-1" aria-labelledby="nd-offcanvas-right-label">
  <div class="flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
    <h3 id="nd-offcanvas-right-label" class="font-bold text-gray-800 dark:text-white">
      Filtros
    </h3>
    <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600" aria-label="Close" data-nd-overlay="#nd-offcanvas-right">
