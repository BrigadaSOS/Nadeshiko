...
onMounted(() => {
  ...
  if (!isMobile) inputRef.value?.focus({ preventScroll: true });
});
...
const enterSubmit = useEnterSubmit(navigateSearchSentence);
  ...
  <div class="yomitan-ignore">
    ...
    >
      <div class="relative flex-[1_0_0%]">
        ...
        <input ref="inputRef" id="sentence-search-input" data-testid="search-input" v-model="query" v-on="enterSubmit"
