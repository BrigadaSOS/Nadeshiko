---
title: "プライバシーポリシー"
description: "Nadeshikoがデータをどのように収集・使用・保護するかについてご確認ください。"
---
...
- **お客様との連絡**：お客様が利用する機能およびサービスに関連する更新や情報提供の連絡を、メールを通じて行うため（実施にあたり必要または合理的な場合のセキュリティ更新を含みます）。

  これらのメールは2種類に分かれます。**アカウント関連のメール**（ログイン用リンク、メールアドレスの確認、アカウントに関する通知）はサービスの動作の一部であり、常に送信されます。**Nadeshiko からのお知らせメール**（ご登録の1週間後のご案内、お客様ご自身の利用状況の定期的なまとめ、重要なバージョン公開時のお知らせ）は情報提供を目的とするもので、各メール下部のリンクまたはアカウント設定からいつでも配信を停止できます。配信を停止しても、ログイン用リンクやアカウント関連のメールには影響しません。
...
- **サービスプロバイダーと**：当社は、契約に基づき当社の指示のみに従って当社に代わってデータを処理する、少数のプロバイダーを利用しています：
  - **Hetzner** — サービスを稼働させるサーバーのホスティング
  - **Cloudflare** — コンテンツ配信、DNS、メディアの保存、不正利用対策
  - **Zoho（ZeptoMail および Zoho Campaigns）** — 上記メールの送信
  - **PostHog** — サイトの利用状況の測定

**当社はお客様の個人データを販売しません。上記に列挙したサービスプロバイダーを除き、第三者と共有することはありません。**
...
## お問い合わせ
本プライバシーポリシーについてご不明な点がある場合は、以下までご連絡ください。
