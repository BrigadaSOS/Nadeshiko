...
test.describe('Language switching', () => {
  test('switching to Spanish updates UI text', async ({ page }) => {
    ...
    await page.locator('.nd-dropdown-menu').getByText('Spanish').click();
  ...
  test('switching to Japanese updates UI text', async ({ page }) => {
    ...
    const langButton = page.locator('header').getByRole('button', { name: /English/i });
    await langButton.click();
    await page.locator('.nd-dropdown-menu').getByText('Japanese').click();
  ...
  test('search page buttons update when switching language', async ({ page }) => {
    ...
    const langButton = page.locator('header').getByRole('button', { name: /English/i });
    await langButton.click();
    await page.locator('.nd-dropdown-menu').getByText('Spanish', { exact: true }).click();
