 ...
 *
 */
export const reportShirabeRefusal = <ThrowOnError extends boolean = false>(options: Options<ReportShirabeRefusalData, ThrowOnError>): RequestResult<ReportShirabeRefusalResponses, ReportShirabeRefusalErrors, ThrowOnError> => (options.client ?? client).post<ReportShirabeRefusalResponses, ReportShirabeRefusalErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'nadeshiko.session_token',
            type: 'apiKey'
 ...
 *
 */
export const unsubscribeFromEmail = <ThrowOnError extends boolean = false>(options: Options<UnsubscribeFromEmailData, ThrowOnError>): RequestResult<UnsubscribeFromEmailResponses, UnsubscribeFromEmailErrors, ThrowOnError> => (options.client ?? client).post<UnsubscribeFromEmailResponses, UnsubscribeFromEmailErrors, ThrowOnError>({ url: '/v1/email/unsubscribe', ...options });
 ...
 *
 */
export const getEmailPreferencesByToken = <ThrowOnError extends boolean = false>(options: Options<GetEmailPreferencesByTokenData, ThrowOnError>): RequestResult<GetEmailPreferencesByTokenResponses, GetEmailPreferencesByTokenErrors, ThrowOnError> => (options.client ?? client).get<GetEmailPreferencesByTokenResponses, GetEmailPreferencesByTokenErrors, ThrowOnError>({ url: '/v1/email/preferences', ...options });
 ...
 *
 */
export const updateEmailPreferencesByToken = <ThrowOnError extends boolean = false>(options: Options<UpdateEmailPreferencesByTokenData, ThrowOnError>): RequestResult<UpdateEmailPreferencesByTokenResponses, UpdateEmailPreferencesByTokenErrors, ThrowOnError> => (options.client ?? client).patch<UpdateEmailPreferencesByTokenResponses, UpdateEmailPreferencesByTokenErrors, ThrowOnError>({
 ...
 *
 */
export const listTiers = <ThrowOnError extends boolean = false>(options?: Options<ListTiersData, ThrowOnError>): RequestResult<ListTiersResponses, ListTiersErrors, ThrowOnError> => (options?.client ?? client).get<ListTiersResponses, ListTiersErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'nadeshiko.session_token',
            type: 'apiKey'
 ...
 *
 */
export const getAdminUserQuota = <ThrowOnError extends boolean = false>(options: Options<GetAdminUserQuotaData, ThrowOnError>): RequestResult<GetAdminUserQuotaResponses, GetAdminUserQuotaErrors, ThrowOnError> => (options.client ?? client).get<GetAdminUserQuotaResponses, GetAdminUserQuotaErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'nadeshiko.session_token',
            type: 'apiKey'
 ...
 *
 */
export const updateAdminUserQuota = <ThrowOnError extends boolean = false>(options: Options<UpdateAdminUserQuotaData, ThrowOnError>): RequestResult<UpdateAdminUserQuotaResponses, UpdateAdminUserQuotaErrors, ThrowOnError> => (options.client ?? client).patch<UpdateAdminUserQuotaResponses, UpdateAdminUserQuotaErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'nadeshiko.session_token',
            type: 'apiKey'
 ...
 */
export const signInWithEmailOtp = <ThrowOnError extends boolean = false>(options: Options<SignInWithEmailOtpData, ThrowOnError>): RequestResult<SignInWithEmailOtpResponses, SignInWithEmailOtpErrors, ThrowOnError> => (options.client ?? client).post<SignInWithEmailOtpResponses, SignInWithEmailOtpErrors, ThrowOnError>({
