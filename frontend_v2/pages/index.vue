                        ...
                        <div
                          ...
                          <div v-else role="status" v-for="i in 10" class="animate-pulse relative">
                            ...
                            <div class="text-center mt-1 mb-4 justify-center flex flex-col items-center">
                              <div class="h-2.5 bg-gray-200 rounded-full dark:bg-[rgba(255,255,255,0.1)] w-28 mb-4">
                              </div>
                            </div>
                          </div>
                          ...
                          <div v-if="mediaError"
                            ...
                            <div class=" rounded-lg">
                              <div role="alert"
                                ...
                                <div class="flex items-center gap-2 mb-2 text-red-800 dark:text-red-100">
                                ...
                                <UiButtonPrimaryAction @click="fetchMedia">
                                  ...
                                  <template v-else>
                                    <UiBaseIcon :path="mdiRefresh" @click="fetchMedia" />
                                    Reintentar conexión
                                  </template>
