...
const getWordMatch = async () => {
  ...
  let response = await fetch(import.meta.env.VITE_APP_BASE_URL_BACKEND + 'search/media/match/words', {
    method: 'POST',
    mode: 'cors',
    headers: {
...
<template>
  <div
    id="hs-vertically-centered-scrollable-batch"
        ...
        <div class="overflow-y-auto">
          <div class="flex flex-row mx-auto">
            <div class="sm:mx-4 mx-auto flex flex-col">
              ...
              <div class="space-y-4">
                <!-- Card -->
                <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-modal-input dark:border-modal-border">
