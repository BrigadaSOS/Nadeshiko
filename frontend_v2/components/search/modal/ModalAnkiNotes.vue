...
const getNotesFromQuery = async () => {
  try {
    const query = keyValue.value
      ? `${keyValue.value}:${inputVal.value}`
      : inputVal.value;
...
<template>
  <div
    id="hs-vertically-centered-scrollable-anki-collection"
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="overflow-y-auto">
          <div class="flex flex-row mx-auto">
            ...
            <div class="border rounded-lg overflow-hidden dark:border-modal-border">
                ...
                <section v-if="!inputVal" class="rounded-xl mx-auto">
        ...
        <div
          class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-modal-border"
        >
          <button
            type="button"
