...
<template>
    ...
    <div class="fixed right-6 bottom-6 z-50 group">
        ...
        <button type="button" data-hs-overlay="#docs-sidebar" aria-controls="docs-sidebar"
            ...
            <svg aria-hidden="true" class="w-8 h-8 transition-transform" fill="none" stroke="currentColor"
