...
watch(() => store.isLoggedIn, async (newVal) => {
  if (newVal) {
            ...
            <div class="mx-4 sm:w-[60vh] w-full flex flex-col">
              <nav class="relative mt-2 z-0 flex border overflow-hidden border-none" aria-label="Tabs" role="tablist">
                <button type="button"
                  ...
                  aria-controls="bar-with-underline-1" role="tab" @click="activeTab = 0" :class="{
                    'border-b-header-background dark:border-b-header-background text-white': activeTab == 0,
                ...
                <button type="button"
                  ...
                  aria-controls="bar-with-underline-2" role="tab" :class="{
                    'border-b-header-background dark:border-b-header-background text-white': activeTab == 1,
                  ...
                  <div class="p-4 sm:px-7 mb-3">
                    <div class="text-center">
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <button class="text-blue-600 decoration-2 hover:underline font-medium"
                          data-hs-tab="#bar-with-underline-2" aria-controls="bar-with-underline-2"
                          id="bar-with-underline-item-2" role="tab" @click="activeTab = 1">
                          Registrate aquí
                        </button>
                      </p>
                    </div>
                    <div class="mt-5 flex flex-col">
                      ...
                      <UiButtonPrimaryAction @click="redirectToDiscordAuth"
                        ...
                        <svg class="w-5 h-5" viewBox="0 0 280 280" version="1.1" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="grid gap-y-4">
                          ...
                          <div>
                            <div class="flex justify-between items-center">
                              ...
                              <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium">¿Contraseña
                                olvidada?</a>
                            </div>
                            <div class="relative">
                          ...
                          <div class="flex items-center">
                            ...
                            <div class="ml-3">
                              <label for="remember-me" class="text-sm dark:text-white">Recuerda mi inicio de
                                sesión</label>
                            </div>
                          </div>
                          <!-- End Checkbox -->
                          <UiButtonPrimaryAction @click="store.login(email, password)"
                          ...
                          <form autocomplete="off">
                            <div class="grid gap-y-4">
                              ...
                              <div>
                                ...
                                <div class="relative">
                                  <input type="email" autocomplete="chrome-off" value=""
                              ...
                              <div class="flex justify-between space-x-4">
                                ...
                                <div class="flex-grow">
                                  <div class="flex justify-between items-center">
                                    <label class="block text-sm mb-2 dark:text-white">Repetir Contraseña</label>
                                  </div>
                                  <div class="relative">
                                    <input type="password" v-model="passwordRepeat" autocomplete="off"
                                      class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-sgray2 dark:border-gray-700 dark:text-gray-400"
                                      required />
                                    <div
                                      class="hidden absolute inset-y-0 right-0 flex items-center pointer-events-none pr-3">
