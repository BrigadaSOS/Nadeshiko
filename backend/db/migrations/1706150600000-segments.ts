  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      CREATE TABLE "Segment" (
        ...
        "content_spanish" varchar(500) NOT NULL CHECK ("content_spanish" <> ''),
        "content_spanish_mt" boolean NOT NULL DEFAULT false,
        "content_english" varchar(500) NOT NULL CHECK ("content_english" <> ''),
        "content_english_mt" boolean NOT NULL DEFAULT false,
        "content_rating" content_rating NOT NULL,
        "rating_analysis" jsonb NOT NULL CHECK ("rating_analysis" <> '{}'::jsonb),
        "pos_analysis" jsonb NOT NULL CHECK ("pos_analysis" <> '{}'::jsonb),
        "storage" segment_storage NOT NULL DEFAULT 'R2',
        "hashed_id" varchar NOT NULL CHECK ("hashed_id" <> ''),
