...
describe('toEpisodeDTO', () => {
  ...
  it('converts Date airedAt to ISO string', () => {
    const dto = toEpisodeDTO(buildEpisode({ airedAt: new Date('2025-03-20T12:30:00Z') }) as any);
...
describe('toEpisodeListDTO', () => {
  it('maps array of episodes', () => {
    const dtos = toEpisodeListDTO([buildEpisode(), buildEpisode(), buildEpisode()] as any);
