...
import { GetContextAnime, SearchAnimeSentences, GetWordsMatched, updateSegment, SearchAnimeSentencesHealth } from "../controllers/mediaController";
...
router.get('/v1/search/health', searchFetchLimiter, authenticate({ apiKey: true }), hasPermissionAPI(['READ_MEDIA']), SearchAnimeSentencesHealth)
