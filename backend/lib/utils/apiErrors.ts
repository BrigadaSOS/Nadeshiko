...
export class AuthCredentialsRequiredError extends ApiError {
  ...
  readonly status = 401;
  static readonly DEFAULT_DETAIL =
    'No API key or session credentials were provided. Please include an X-API-Key header or a valid session cookie.';
...
export class NotFoundError extends ApiError {
  ...
  // Static helper methods for common not found scenarios
  static forUser(): NotFoundError {
    return new NotFoundError('User not found');
  }

  static forMedia(): NotFoundError {
    return new NotFoundError('Media not found');
  }

  static forEpisode(): NotFoundError {
    return new NotFoundError('Episode not found');
  }

  static forSegment(): NotFoundError {
    return new NotFoundError('Segment not found');
  }
