...
export type LoginDiscord = (
  params: Params<void, void, DiscordLoginRequestOutput, t_LoginDiscordRequestHeaderSchema>,
...
export type LoginGoogle = (
  params: Params<void, void, GoogleLoginRequestOutput, t_LoginGoogleRequestHeaderSchema>,
...
export type Login = (
  params: Params<void, void, LoginRequestOutput, t_LoginRequestHeaderSchema>,
...
export type Register = (
  params: Params<void, void, RegisterRequestOutput, t_RegisterRequestHeaderSchema>,
...
export function createAuthRouter(implementation: AuthImplementation): Router {
  ...
  // getDiscordAuthUrl
  router.get(`/v1/auth/discord/url`, async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = {
        params: undefined,
        query: undefined,
        body: undefined,
        headers: parseRequestInput(getDiscordAuthUrlRequestHeaderSchema, req.headers, RequestInputType.RequestHeader),
      };
      ...
      const response = await implementation.getDiscordAuthUrl(input, responder, req, res, next).catch((err) => {
  ...
  // loginDiscord
  router.post(`/v1/auth/discord`, async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = {
        params: undefined,
        query: undefined,
        body: parseRequestInput(loginDiscordRequestBodySchema, req.body, RequestInputType.RequestBody),
        headers: parseRequestInput(loginDiscordRequestHeaderSchema, req.headers, RequestInputType.RequestHeader),
      };
      ...
      const response = await implementation.loginDiscord(input, responder, req, res, next).catch((err) => {
        throw ExpressRuntimeError.HandlerError(err);
      });
  ...
  // loginGoogle
  router.post(`/v1/auth/google`, async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = {
        params: undefined,
        query: undefined,
        body: parseRequestInput(loginGoogleRequestBodySchema, req.body, RequestInputType.RequestBody),
        headers: parseRequestInput(loginGoogleRequestHeaderSchema, req.headers, RequestInputType.RequestHeader),
      };
      ...
      const response = await implementation.loginGoogle(input, responder, req, res, next).catch((err) => {
        throw ExpressRuntimeError.HandlerError(err);
      });
  ...
  router.post(`/v1/auth/login`, async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = {
        ...
        headers: parseRequestInput(loginRequestHeaderSchema, req.headers, RequestInputType.RequestHeader),
      };
  ...
  // register
  router.post(`/v1/auth/register`, async (req: Request, res: Response, next: NextFunction) => {
    try {
      const input = {
        params: undefined,
        query: undefined,
        body: parseRequestInput(registerRequestBodySchema, req.body, RequestInputType.RequestBody),
        headers: parseRequestInput(registerRequestHeaderSchema, req.headers, RequestInputType.RequestHeader),
      };
      ...
      const response = await implementation.register(input, responder, req, res, next).catch((err) => {
        throw ExpressRuntimeError.HandlerError(err);
      });
