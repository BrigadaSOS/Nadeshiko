    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const response = await implementation
          .searchHealthCheck(input, responder, req, res, next)
          .catch((err) => {
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        const input = {
          ...
          query: undefined,
          body: parseRequestInput(
            searchMultipleRequestBodySchema,
            req.body,
            RequestInputType.RequestBody,
          ),
          headers: undefined,
        ...
        const response = await implementation
          .searchMultiple(input, responder, req, res, next)
          .catch((err) => {
            throw ExpressRuntimeError.HandlerError(err)
          })
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        const input = {
          ...
          query: undefined,
          body: parseRequestInput(
            fetchSentenceContextRequestBodySchema,
            req.body,
            RequestInputType.RequestBody,
          ),
          headers: undefined,
        ...
        const responder = {
          with200() {
            return new ExpressRuntimeResponse<t_FetchSentenceContextResponse>(
              200,
            )
          },
          with400() {
        ...
        const response = await implementation
          .fetchSentenceContext(input, responder, req, res, next)
          .catch((err) => {
            throw ExpressRuntimeError.HandlerError(err)
          })
  ...
  router.get(
    ...
    async (req: Request, res: Response, next: NextFunction) => {
      try {
        ...
        const response = await implementation
          .fetchMediaInfo(input, responder, req, res, next)
          .catch((err) => {
            throw ExpressRuntimeError.HandlerError(err)
          })
